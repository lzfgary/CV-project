...
## Area of improvements:
  ...
  - Model 2 significantly outperforms Model 1 which indicates that there is still plenty of space for improvement. And we probably should change the number of layers in our model while prevent overfitting.
